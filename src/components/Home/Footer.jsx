                ...
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
                        <div className="p-4 md:w-1/3 flex flex-col text-center items-center">
                            ...
                            <div className="grow">
                                <h2 className="text-gray-900 text-lg title-font font-medium mb-3">{props.FooterContaint.Cards.Card1.Title}</h2>
                                <p className="leading-relaxed text-base">{props.FooterContaint.Cards.Card1.Description}</p>
                                <a href="#" className="mt-3 text-indigo-500 inline-flex items-center">{props.FooterContaint.Cards.Card1.Button}
                        ...
                        <div className="p-4 md:w-1/3 flex flex-col text-center items-center">
                            ...
                            <div className="grow">
                                <h2 className="text-gray-900 text-lg title-font font-medium mb-3">{props.FooterContaint.Cards.Card2.Title}</h2>
                                <p className="leading-relaxed text-base">{props.FooterContaint.Cards.Card2.Description}</p>
                                <a href="#" className="mt-3 text-indigo-500 inline-flex items-center">{props.FooterContaint.Cards.Card2.Button}
                                    <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24">
                                        <path d="M5 12h14M12 5l7 7-7 7"></path>
                                    </svg>
                                </a>
                        ...
                        <div className="p-4 md:w-1/3 flex flex-col text-center items-center">
                            ...
                            <div className="grow">
                                <h2 className="text-gray-900 text-lg title-font font-medium mb-3">{props.FooterContaint.Cards.Card3.Title}</h2>
                                <p className="leading-relaxed text-base">{props.FooterContaint.Cards.Card2.Description}</p>
                                <a href="#" className="mt-3 text-indigo-500 inline-flex items-center">{props.FooterContaint.Cards.Card3.Button}
                                    <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24">
                                        <path d="M5 12h14M12 5l7 7-7 7"></path>
                                    </svg>
                                </a>
                    ...
                    <button className="flex mx-auto mt-16 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">{props.FooterContaint.Button}</button>
                </div>
            </section>
                ...
                <div className="container px-5 py-0 mx-auto">
                    <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
                        ...
                        <p className="leading-relaxed text-lg">
                            {props.FooterContaint.Description}
                        </p>
                        <span className="inline-block h-1 w-10 rounded bg-indigo-500 mt-8 mb-6" />

                        <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm">{props.FooterContaint.SubHeading}</h2>
                        <p className="text-gray-500">{props.FooterContaint.SubDescription}</p>
                    </div>
                </div>
            </section>
