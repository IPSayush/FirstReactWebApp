          ...
          <div className="lg:grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            ...
            <div className="flex w-full md:justify-start justify-center items-end">
              <div className="relative mr-4 lg:w-full xl:w-1/2 w-2/4">
                <label for="hero-field" className="leading-7 text-sm text-gray-200">Placeholder</label>
              ...
              <button className="inline-flex text-white bg-[#394024] border-0 py-2 px-6 focus:outline-none hover:bg-[#696143] rounded text-lg">Button</button>
            </div>
            <p className="text-sm mt-2 text-gray-950 mb-8 w-full">Neutra shabby chic ramps, viral fixie.</p>
          </div>
        </div>
      </section>
    </>
